    ...
    <form class="needs-validation" novalidate method="POST"
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="detaliiConcurs" name="detaliiConcurs" maxlength="255"
                   value="${keepValues ? detaliiConcurs : ''}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="dataDesfasurare" name="dataDesfasurare" required
                   value="${keepValues ? dataDesfasurare : ''}">
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="startInscrieri" name="startInscrieri" required
                   value="${keepValues ? startInscrieri : ''}">
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="stopInscrieri" name="stopInscrieri" required
                   value="${keepValues ? stopInscrieri : ''}">
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="competitionType" name="competitionType" required>
                ...
                <option value="software" ${keepValues && competitionType == 'software' ? 'selected' : ''}>software</option>
                <option value="hardware" ${keepValues && competitionType == 'hardware' ? 'selected' : ''}>hardware</option>
                <option value="mixed" ${keepValues && competitionType == 'mixed' ? 'selected' : ''}>mixed</option>
            </select>
            <div class="invalid-feedback">
